    ...
    <form:form method="POST" modelAttribute="cartForm"
        ...
        <c:forEach items="${cartForm.cartLines}" var="cartLineInfo"
            ...
            <div class="product-preview-container">
                <ul>
                    <li><img class="product-image" src="${pageContext.request.contextPath}/productImage?code=${cartLineInfo.productInfo.code}" />
                    </li>
        ...
        <c:if test="${pageContext.request.userPrincipal.name != null}">
            <a href="${pageContext.request.contextPath}/shoppingCartCustomer">Checkout</a>
        </c:if>
        <c:if test="${pageContext.request.userPrincipal.name == null}">
        ...
        <a class="navi-item"
           href="${pageContext.request.contextPath}/productList">Return to Store</a>
    </form:form>
